 ...
 * @author Fernando
 */
public class EstadoForm extends javax.swing.JDialog {
     ...
     */
    public EstadoForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void excluir() {
        EstadoDao dao = new EstadoDaoImpl();
        estado = dao.getById(estado.getIdEstado());
        dao.delete(estado);
